...
var _YelpAuth = require("./YelpAuth");

var _YelpAuth2 = _interopRequireDefault(_YelpAuth);
	...
	_createClass(TokenManager, [{
		...
		value: function renewToken() {
			...
			this.getNewToken().then(function (res) {
				...
				console.log("yelp access_token:", _this.__accessToken);
			}).catch(function (err) {
		...
		value: function getNewToken() {
			...
			console.log("yelp client id:", _YelpAuth2.default.client_id);
			console.log("yelp client secret", _YelpAuth2.default.client_secret);
			console.log("Getting access token...");

			// get the access token
			return _axios2.default.post("https://api.yelp.com/oauth2/token", "grant_type=client_credentials&client_id=" + _YelpAuth2.default.client_id + "&client_secret=" + _YelpAuth2.default.client_secret);
		}
	}]);
